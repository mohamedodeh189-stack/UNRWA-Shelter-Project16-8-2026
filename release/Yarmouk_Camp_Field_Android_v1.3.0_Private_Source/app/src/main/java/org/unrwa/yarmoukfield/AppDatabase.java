...
public final class AppDatabase extends SQLiteOpenHelper {
    ...
    public AppDatabase(Context context) { super(context, "yarmouk_field.db", null, 2); }
    ...
    public JSONObject backup(long projectId,String projectName) throws Exception {
        JSONObject root=new JSONObject();root.put("schema_version","1.1");root.put("project",projectName);root.put("exported_at",System.currentTimeMillis());
