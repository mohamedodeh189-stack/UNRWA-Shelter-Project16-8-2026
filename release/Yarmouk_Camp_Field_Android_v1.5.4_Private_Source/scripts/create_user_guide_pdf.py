...
OUTPUT = ROOT / "output" / "pdf" / "Yarmouk_Camp_Field_User_Guide_AR_v1.5.4.pdf"
...
def build() -> None:
    ...
    c.setFont("Arabic", 12)
    c.setFillColor(white)
    c.drawRightString(WIDTH - MARGIN, HEIGHT - 300, rtl("الإصدار 1.5.4 - يعمل دون إنترنت"))
    ...
    y2 -= 8
    draw_rtl(c, "الإصدار 1.5.4 - مشروع المأوى في مخيم اليرموك - آب 2026", WIDTH - MARGIN - 22, y2, WIDTH - 2 * MARGIN - 44, size=10, color=MUTED)
    c.save()
