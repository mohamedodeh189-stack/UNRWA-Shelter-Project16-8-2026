...
- Version: `1.5.2` (`versionCode 152`)
- APK: `dist/Yarmouk_Camp_Field_Android_v1.5.2.apk`
- SHA-256: `A333F965D3143DFE6EEA41046CBA085D5B7F85D7DBD9B3E9E7387442E3183AD5`
...
- Full Java/resource/DEX build for V1.5.2 succeeded after the safe-inset change.
- APK signatures v2 and v3 were verified with the existing release key.
- APK package/version: `org.unrwa.yarmoukfield`, `1.5.2` / `152`.
...
- The V1.5.2 user guide is A4, seven pages, and all pages were rendered to PNG and visually inspected after the calculator/security/credit updates.
...
1. Install V1.5.2 over the current app and confirm previous beneficiaries and photos remain available after the database upgrade.
