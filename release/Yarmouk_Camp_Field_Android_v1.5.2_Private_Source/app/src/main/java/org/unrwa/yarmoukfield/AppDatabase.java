...
public final class AppDatabase extends SQLiteOpenHelper {
    ...
    public AppDatabase(Context context) { super(context, "yarmouk_field.db", null, 5); }
    ...
    @Override public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if(oldVersion<5)db.execSQL("ALTER TABLE beneficiaries ADD COLUMN progress_percent INTEGER DEFAULT 0");
    }
