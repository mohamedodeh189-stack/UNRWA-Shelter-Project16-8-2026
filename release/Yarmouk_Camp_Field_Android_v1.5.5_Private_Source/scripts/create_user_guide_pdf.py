...
OUTPUT = ROOT / "output" / "pdf" / "Yarmouk_Camp_Field_User_Guide_AR_v1.5.5.pdf"
...
def build() -> None:
    ...
    c.setFont("Arabic", 12)
    c.setFillColor(white)
    c.drawRightString(WIDTH - MARGIN, HEIGHT - 300, rtl("الإصدار 1.5.5 - يعمل دون إنترنت"))
    ...
    y = card(c, y, "المخطط الكامل والقطاعات", "المخطط الكامل للنظرة العامة لأن أسماء مصدره مرسومة كأشكال CAD سميكة. لقراءة أسماء الشوارع بوضوح افتح صفحة القطاع من الحدود الملونة؛ صفحات القطاعات تستخدم خط NART المضمّن.", accent=BLUE, height=104)
    ...
    y2 -= 8
    draw_rtl(c, "الإصدار 1.5.5 - مشروع المأوى في مخيم اليرموك - آب 2026", WIDTH - MARGIN - 22, y2, WIDTH - 2 * MARGIN - 44, size=10, color=MUTED)
    c.save()
